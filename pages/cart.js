			...
			<GridBlock>
				{items.length > 0 ? (
					<div className={styles.Cart}>
						<div className={styles.Header}>
							<div className={styles.Title}>
								<Image src="/img/cart.svg" alt="cart" width={29} height={29} />
								<h1>Корзина</h1>
							</div>
						...
						<div className={styles.Footer}>
							<div className={styles.FinalInformation}>
								<div>
									...
									<span className={styles.FinalInformationPizzas}>{totalCount} шт.</span>
								</div>
								<div>
									<span>Сумма заказа: </span>
									<span className={styles.FinalInformationPrice}>{totalPrice} ₽</span>
								</div>
							</div>
					...
					<div className={styles.CartEmpty}>
						<Image src="/img/empty-cart.png" alt="empty cart" width={300} height={300} />
						...
						<Link href="/">
							<Button className={styles.ButtonBackEmpty}>Вернуться назад</Button>
						</Link>
					</div>
				)}
			</GridBlock>
